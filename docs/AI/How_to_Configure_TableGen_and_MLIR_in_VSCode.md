...
![png1](../../static/img/AI/How_to_Configure_TableGen_and_MLIR_in_VSCode/AI_vscode_TableGen_1.png)
下载图中用红框圈住的插件后进入`ctrl+，`快捷键进入设置界面，输入`tablegen-lsp.includePaths`
## 第二步：
![png2](../../static/img/AI/How_to_Configure_TableGen_and_MLIR_in_VSCode/AI_vscode_TableGen_2.png)
