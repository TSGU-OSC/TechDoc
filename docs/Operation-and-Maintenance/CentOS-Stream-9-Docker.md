...
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image.png)
...
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-1.png)
...
下载各个组件最新版本即可 
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-3.png)
将所有rpm打包 可以使用scp命令进行上传
```
scp Archive.zip jack@192.168.31.86:/home/jack/Documents
```
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-2.png)
...
```
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-6.png)
启动服务
```
...
```
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-7.png)
使用vim写入``{ "registry-mirrors": ["https://bb6s1gkq.mirror.aliyuncs.com"] }``
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-8.png)
...
```
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-9.png)
下载网络工具
```
...
ifconfig
```
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-11.png)
将ip地址输入至浏览器
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-10.png)

打包vue前端项目 找到``.env.production``文件 修改``VITE_APP_BASE_API``为虚拟机的ip地址加后端留出的端口
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-27.png)
...
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-13.png)
重新开一个terminal 可以将dist目录打包上传至虚拟机，在此笔者就演示scp命令
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-16.png)
...
```
编辑vue.conf 输入以下内容
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-14.png)
将此配置文件复制进nginx容器内 具体参考图片内的命令。然后复制dist目录，发现没有app目录，于是进入容器创建此目录
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-17.png)
...
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-15.png)
...
```
下载passwd成功 证明换源成功
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-18.png)
设置密码
```
passwd root
```
...
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-19.png)
点击IDEA右侧的Maven项目管理工具，点击package一键打包
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-20.png)
在项目目录下的targets目录找到jar包 上传至centos
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-21.png)
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-22.png)
...
```
将项目sql脚本上传
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-24.png)
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-25.png)
将脚本复制进mysql容器并运行
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-26.png)

访问网页 成功登入 前 后 数据库已成功连接
![Alt text](../../static/img/Operation-and-Maintenance/CentOS-Stream-9-Docker/image-12.png)
