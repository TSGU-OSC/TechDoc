...
```
如图所示
![Alt text](../../../static/img/Back-end/C++/ffmpeg_develop/image-3.png)

### 下载源代码

* [源代码下载官网](https://ffmpeg.org/releases/)
选择你需要的版本，比如 `ffmpeg-3.4.1.tar.gz `或`ffmpeg-3.4.1.tar.xz `![Alt text](../../../static/img/Back-end/C++/ffmpeg_develop/image-2.png)
