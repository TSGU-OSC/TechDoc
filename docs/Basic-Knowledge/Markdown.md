...
>
> ![Tag](../../static/img/Basic-knowledge/Markdown/Tag.png)	
...
>
> ![Paragraphs](../../static/img/Basic-knowledge/Markdown/Paragraphs.png)
...
> ![Line-feed](../../static/img/Basic-knowledge/Markdown/Line-feed.png)  
...
>
> ![Emphasis-bold](../../static/img/Basic-knowledge/Markdown/Emphasis-bold.png)
...
- 在表格中嵌套其他语法
  ...
  - 文段1
  - 文段2
  ![Linux](../../static/img/Basic-knowledge/Markdown/Linux.png)
  // ![图片Alt](图片地址)
  - 文段4
  ```
...
>
> ![List-Ordered](../../static/img/Basic-knowledge/Markdown/List-Ordered.png)
...
> **// 原文档没有翻译，使用了机翻，逻辑与表达上可能存在某些问题** 
>
> ![List-unordered](../../static/img/Basic-knowledge/Markdown/List-unordered.png)
...
>
> ![Segmentation](../../static/img/Basic-knowledge/Markdown/Segmentation.png)
...
![Example1](../../static/img/Basic-knowledge/Markdown/Example1.png)

- 第二种：

[![示例图片2](../../static/img/Basic-knowledge/Markdown/Example2.png)](https://markdown.com.cn/)
...
![Flow-chart](../../static/img/Basic-knowledge/Markdown/Flow-chart.png)

#### **时序图，也称序列图**

![Sequence-diagram](../../static/img/Basic-knowledge/Markdown/Sequence-diagram.png)

#### **思维导图**  

![Logic-diagram](../../static/img/Basic-knowledge/Markdown/Logic-diagram.png)

#### **甘特图**

![Gantt-chart](../../static/img/Basic-knowledge/Markdown/Gantt-chart.png)
